...
const PROFESSOR_ADVISORIES = {
  "양삼석": {
    text: "공개 보도에 따르면, 이 교수는 2011년 성희롱 논란으로 부산대 성희롱·성폭력 상담소 및 국가인권위원회 조사에서 성희롱이 인정되어 학교로부터 정직 3개월 징계를 받았으며, 일부 학생·대학원생은 처분이 미흡하다고 반발한 바 있습니다(본인은 고의성을 부인하며 이의를 제기함). 2011~2013년 보도이며, 동명이인일 가능성을 배제할 수 없으니 정확한 사실관계는 아래 원문과 학교 공식 채널을 통해 직접 확인하시기 바랍니다.",
    sources: [
